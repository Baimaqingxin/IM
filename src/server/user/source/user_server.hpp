...
#include "../../common/data_es.hpp"      // es数据管理客户端封装
#include "../../common/data_redis.hpp"      // redis数据管理客户端封装
#include "../../common/mysql_user.hpp"      // mysql数据管理客户端封装
#include "../../common/etcd.hpp"     // 服务注册模块封装
#include "../../common/logger.hpp"   // 日志模块封装
#include "../../common/utils.hpp"    // 基础工具接口
#include "../../common/dms.hpp"      // 短信平台SDK模块封装
#include "../../common/channel.hpp"  // 信道管理模块封装

#include "../../odb/user.hxx"
#include "../../odb/user-odb.hxx"

#include "../../proto/user.pb.h"  // protobuf框架代码
#include "../../proto/base.pb.h"  // protobuf框架代码
#include "../../proto/file.pb.h"  // protobuf框架代码
...
private:
    // 使用elasticsearch进行信息的检索
    ESUser::ptr _es_user;

    // 使用ODB来对数据库的对象进行操作
    UserTable::ptr _mysql_user;

    // 使用Redis来对于会话、登录状态、验证码服务进行管理
...
private:
    // 下面都是搭建服务所必须的内容，但是如何保证这些服务都能顺利运行？所以需要一个Builder类
