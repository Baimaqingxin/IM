...
DEFINE_string(mysql_user, "windowsusr", "Mysql服务器访问用户名");
DEFINE_string(mysql_pswd, "zhaobohanREDIS", "Mysql服务器访问密码");
...
DEFINE_string(dms_key_id, "LTAI5tNwdHxeTeqUmdmWqp61", "短信平台密钥ID");
DEFINE_string(dms_key_secret, "HKLyXzVsFYv9QlvOfAzCKx1yxk9gcL", "短信平台密钥");
